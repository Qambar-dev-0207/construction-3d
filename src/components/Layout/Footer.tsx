        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/services" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Interior Design</Link></li>
              <li><Link to="/services" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Architectural Design</Link></li>
              <li><Link to="/services" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Construction</Link></li>
              <li><Link to="/services" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">3D Modeling</Link></li>
              <li><Link to="/services" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Renovation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/projects" className="text-primary-foreground/80 hover:text-primary-foreground transition-colors">Projects</Link></li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-primary-foreground/80 mb-2">123 Design Avenue</p>
              <p className="text-primary-foreground/80 mb-2">New York, NY 10001</p>
              <p className="text-primary-foreground/80 mb-2">+1 (555) 123-4567</p>
              <p className="text-primary-foreground/80 mb-2">info@visionarydesign.com</p>
            </address>
          </div>
        </div>
