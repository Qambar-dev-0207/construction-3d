...
const ContactInfoItem = ({ icon, title, content }: { icon: string; title: string; content: string | React.ReactNode }) => {
  return (
    <div className="flex items-start">
      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mr-4">
        <span className="text-primary" dangerouslySetInnerHTML={{ __html: icon }}></span>
      </div>
      <div>
          ...
          <div className="container mx-auto px-6 py-20 md:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground mb-8 animate-fade-in" style={{ animationDelay: '100ms' }}>
                Whether you're ready to start a project or just have questions, we're here to help. Reach out and let's discuss your vision.
              </p>
            </div>
          </div>
        </section>
