...
const ServiceCard = ({ icon, title, description }: { icon: string; title: string; description: string }) => {
  return (
    <div className="glass-card p-6 transition-all duration-300 hover:shadow-elevation hover:-translate-y-1">
...
const ProjectCard = ({ image, title, category, delay = 0 }: { image: string; title: string; category: string; delay?: number }) => {
  return (
    <div 
